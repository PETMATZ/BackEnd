...
public class ChatDocsCommandAdapter implements ChatDocsInitPort {
    ...
    public void init(ChatRoomInfo chatRoomInfo, long chatRoomID) {
        ...
        ChatReadStatusDocs caregiverChatReadStatusDocs = createdChatReadStatusDocs(chatRoomInfo.caregiverId(),chatRoomID);
        ChatReadStatusDocs entrustedChatReadStatusDocs = createdChatReadStatusDocs(chatRoomInfo.entrustedId(),chatRoomID);
    ...
    private ChatReadStatusDocs createdChatReadStatusDocs(Long userId, long chatRoomID) {
        return ChatReadStatusDocs.initChatReadStatusData(userId, chatRoomID);
    }
