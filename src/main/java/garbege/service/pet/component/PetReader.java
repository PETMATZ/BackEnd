...
//    }
//
//    public List<Pet> getPetList(List<Long> petsId) {
//        List<Pet> petList = petRepository.findAllById(petsId);
//        if (petList.isEmpty()) {
//            throw new SosBoardServiceException(SosBoardErrorCode.PET_NOT_FOUND);
//        }
//        return petList;
//    }
//
